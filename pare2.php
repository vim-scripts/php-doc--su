...
load_entities('phpdoc/zh/language-defs.ent');
load_entities('phpdoc/zh/language-snippets.ent');
//load_entities('phpdoc/en/livedocs.ent');
load_entities('phpdoc/zh/extensions.ent');
load_entities('phpdoc/zh/contributors.ent');
//print_r($entities['&example.outputs;']);
//print_r($entities);
//process_all('phpdoc\en\reference');
process_all('phpdoc/zh/reference');
